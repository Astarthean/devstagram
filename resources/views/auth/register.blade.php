            ...
            <form action="/crear-cuenta" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror"
                        value="{{ old('name') }}" type="text" name="name" id="name" placeholder="Tu Nombre">
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input class="border p-3 w-full rounded-lg @error('username') border-red-500 @enderror"
                        value="{{ old('username') }}" type="text" name="username" id="username"
                ...
                <div class="mb-5">
                    <label class="mb-2 block uppercase text-gray-500 font-bold" for="password_confirmation">Repetir
                        Contraseña</label>
                    <input class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror"
                        value="{{ old('name') }}" type="password" name="password_confirmation" id="password_confirmation"
